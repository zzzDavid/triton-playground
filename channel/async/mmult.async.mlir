module attributes {torch.debug_module_name = "model"} {
  ...
  func.func @forward(%arg0: memref<32x32xi32>, %arg1: memref<32x32xi32>, %arg2: memref<32x32xi32>, %arg3: memref<32x32xi32>) attributes {llvm.emit_c_interface} {
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%1, %c0, %c0, %2, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%4, %c0, %c0, %5, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%7, %c0, %c0, %8, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_get_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%10, %c0, %c0, %11, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    air.herd @herd_0  tile (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) {
      ...
      func.call @air_channel_get_M0I64_I64_I64_M0D2I32(%25, %arg4, %arg5, %26) : (memref<i64>, index, index, memref<?x?xi32>) -> ()
      ...
      func.call @air_channel_get_M0I64_I64_I64_M0D2I32(%28, %arg4, %arg5, %29) : (memref<i64>, index, index, memref<?x?xi32>) -> ()
      ...
      func.call @air_channel_get_M0I64_I64_I64_M0D2I32(%31, %arg4, %arg5, %32) : (memref<i64>, index, index, memref<?x?xi32>) -> ()
      ...
      func.call @air_channel_put_M0I64_I64_I64_M0D2I32(%34, %arg4, %arg5, %35) : (memref<i64>, index, index, memref<?x?xi32>) -> ()
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%13, %c0, %c0, %14, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%16, %c0, %c0, %17, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%19, %c0, %c0, %20, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
    ...
    call @air_channel_get_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(%22, %c0, %c0, %23, %c0, %c0, %c32, %c32, %c32, %c1) : (memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) -> ()
  ...
  func.func private @air_channel_put_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) attributes {llvm.emit_c_interface}
  func.func private @air_channel_get_M0I64_I64_I64_M0D2I32_I64_I64_I64_I64_I64_I64(memref<i64>, index, index, memref<?x?xi32>, index, index, index, index, index, index) attributes {llvm.emit_c_interface}
  func.func private @air_channel_get_M0I64_I64_I64_M0D2I32(memref<i64>, index, index, memref<?x?xi32>) attributes {llvm.emit_c_interface}
  func.func private @air_channel_put_M0I64_I64_I64_M0D2I32(memref<i64>, index, index, memref<?x?xi32>) attributes {llvm.emit_c_interface}
}
