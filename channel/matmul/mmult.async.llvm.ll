...
define void @air_channel_get_M0I64_M0D2I32(ptr %0, ptr %1, i64 %2, ptr %3, ptr %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9) {
  %11 = insertvalue { ptr, ptr, i64 } undef, ptr %0, 0
  %12 = insertvalue { ptr, ptr, i64 } %11, ptr %1, 1
  %13 = insertvalue { ptr, ptr, i64 } %12, i64 %2, 2
  %14 = alloca { ptr, ptr, i64 }, i64 1, align 8
  store { ptr, ptr, i64 } %13, ptr %14, align 8
  %15 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } undef, ptr %3, 0
  %16 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %15, ptr %4, 1
  %17 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %16, i64 %5, 2
  %18 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %17, i64 %6, 3, 0
  %19 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %18, i64 %8, 4, 0
  %20 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %19, i64 %7, 3, 1
  %21 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %20, i64 %9, 4, 1
  %22 = alloca { ptr, ptr, i64, [2 x i64], [2 x i64] }, i64 1, align 8
  store { ptr, ptr, i64, [2 x i64], [2 x i64] } %21, ptr %22, align 8
  call void @_mlir_ciface_air_channel_get_M0I64_M0D2I32(ptr %14, ptr %22)
  ret void
}

declare void @_mlir_ciface_air_channel_get_M0I64_M0D2I32(ptr, ptr)

define void @air_channel_put_M0I64_M0D2I32(ptr %0, ptr %1, i64 %2, ptr %3, ptr %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9) {
  %11 = insertvalue { ptr, ptr, i64 } undef, ptr %0, 0
  %12 = insertvalue { ptr, ptr, i64 } %11, ptr %1, 1
  %13 = insertvalue { ptr, ptr, i64 } %12, i64 %2, 2
  %14 = alloca { ptr, ptr, i64 }, i64 1, align 8
  ...
  %22 = alloca { ptr, ptr, i64, [2 x i64], [2 x i64] }, i64 1, align 8
  store { ptr, ptr, i64, [2 x i64], [2 x i64] } %21, ptr %22, align 8
  call void @_mlir_ciface_air_channel_put_M0I64_M0D2I32(ptr %14, ptr %22)
  ret void
}

declare void @_mlir_ciface_air_channel_put_M0I64_M0D2I32(ptr, ptr)
...
14:                                               ; preds = %0
  ...
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_0, i64 0, ptr %15, ptr %15, i64 0, i64 32, i64 32, i64 32, i64 1)
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_1, i64 0, ptr %16, ptr %16, i64 0, i64 32, i64 32, i64 32, i64 1)
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_2, i64 0, ptr %17, ptr %17, i64 0, i64 32, i64 32, i64 32, i64 1)
  br label %18
...
48:                                               ; preds = %18
  call void @air_channel_put_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_3, i64 0, ptr %17, ptr %17, i64 0, i64 32, i64 32, i64 32, i64 1)
...
14:                                               ; preds = %0
  ...
  %16 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64))
  %17 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64))
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_4, i64 0, ptr %15, ptr %15, i64 0, i64 32, i64 32, i64 32, i64 1)
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_5, i64 0, ptr %16, ptr %16, i64 0, i64 32, i64 32, i64 32, i64 1)
  call void @air_channel_get_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_6, i64 0, ptr %17, ptr %17, i64 0, i64 32, i64 32, i64 32, i64 1)
  br label %18
...
48:                                               ; preds = %18
  call void @air_channel_put_M0I64_M0D2I32(ptr inttoptr (i64 3735928559 to ptr), ptr @channel_7, i64 0, ptr %17, ptr %17, i64 0, i64 32, i64 32, i64 32, i64 1)
  call void @free(ptr %15)
  call void @free(ptr %16)
  call void @free(ptr %17)
  call void @mlirAsyncRuntimeEmplaceToken(ptr %1)
