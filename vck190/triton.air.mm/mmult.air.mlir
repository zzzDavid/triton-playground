...
module {
  func.func @matmul_kernel(%arg0: memref<*xf32>, %arg1: memref<*xf32>, %arg2: memref<*xf32>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32) {
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%19], sizes: [64, 64], strides: [%18, %20] : memref<*xf32> to memref<64x64xf32, strided<[?, ?], offset: ?>>
    %reinterpret_cast_0 = memref.reinterpret_cast %arg1 to offset: [%24], sizes: [64, 64], strides: [%21, %23] : memref<*xf32> to memref<64x64xf32, strided<[?, ?], offset: ?>>
    %alloc_1 = memref.alloc() : memref<64x64xf32>
    memref.copy %alloc, %alloc_1 : memref<64x64xf32> to memref<64x64xf32>
    %27:5 = scf.for %arg15 = %c0 to %26 step %c1 iter_args(%arg16 = %alloc_1, %arg17 = %19, %arg18 = %c0, %arg19 = %24, %arg20 = %c0) -> (memref<64x64xf32>, index, index, index, index) {
      ...
      %subview_5 = memref.subview %reinterpret_cast[0, 0] [64, %47] [1, 1] : memref<64x64xf32, strided<[?, ?], offset: ?>> to memref<64x?xf32, strided<[?, ?], offset: ?>>
      %subview_6 = memref.subview %alloc_4[0, 0] [64, %47] [1, 1] : memref<64x64xf32> to memref<64x?xf32, strided<[64, 1]>>
      ...
      %subview_8 = memref.subview %reinterpret_cast_0[0, 0] [%47, 64] [1, 1] : memref<64x64xf32, strided<[?, ?], offset: ?>> to memref<?x64xf32, strided<[?, ?], offset: ?>>
      %subview_9 = memref.subview %alloc_7[0, 0] [%47, 64] [1, 1] : memref<64x64xf32> to memref<?x64xf32, strided<[64, 1]>>
      scf.if %48 {
      ...
      air.herd @herd_0  tile (%arg21, %arg22) in (%arg23=%c2, %arg24=%c2) args(%arg25=%alloc_4, %arg26=%alloc_7, %arg27=%alloc_11) : memref<64x64xf32>, memref<64x64xf32>, memref<64x64xf32> {
        ...
        scf.for %arg28 = %c0_16 to %c64_17 step %c32 {
          %alloc_18 = memref.alloc() : memref<32x32xf32, 2>
          %alloc_19 = memref.alloc() : memref<32x32xf32, 2>
          %alloc_20 = memref.alloc() : memref<32x32xf32, 2>
          air.dma_memcpy_nd (%alloc_18[] [] [], %arg25[%57, %arg28] [%c32, %c32] [%c64_17, %c1_15]) {id = 1 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
          air.dma_memcpy_nd (%alloc_19[] [] [], %arg26[%arg28, %58] [%c32, %c32] [%c64_17, %c1_15]) {id = 2 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
          air.dma_memcpy_nd (%alloc_20[] [] [], %arg27[%57, %58] [%c32, %c32] [%c64_17, %c1_15]) {id = 3 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
          linalg.matmul ins(%alloc_18, %alloc_19 : memref<32x32xf32, 2>, memref<32x32xf32, 2>) outs(%alloc_20 : memref<32x32xf32, 2>)
          air.dma_memcpy_nd (%arg27[%57, %58] [%c32, %c32] [%c64_17, %c1_15], %alloc_20[] [] []) {id = 4 : i32} : (memref<64x64xf32>, memref<32x32xf32, 2>)
          memref.dealloc %alloc_18 : memref<32x32xf32, 2>
          memref.dealloc %alloc_19 : memref<32x32xf32, 2>
          memref.dealloc %alloc_20 : memref<32x32xf32, 2>
        }
        air.herd_terminator
      }
      ...
      air.herd @herd_1  tile (%arg21, %arg22) in (%arg23=%c2, %arg24=%c2) args(%arg25=%alloc_11, %arg26=%alloc, %arg27=%alloc_12) : memref<64x64xf32>, memref<64x64xf32>, memref<64x64xf32> {
        %c1_15 = arith.constant 1 : index
        ...
        %alloc_18 = memref.alloc() : memref<32x32xf32, 2>
        %alloc_19 = memref.alloc() : memref<32x32xf32, 2>
        air.dma_memcpy_nd (%alloc_17[] [] [], %arg25[%57, %58] [%c32, %c32] [%c64_16, %c1_15]) {id = 5 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
        air.dma_memcpy_nd (%alloc_18[] [] [], %arg26[%57, %58] [%c32, %c32] [%c64_16, %c1_15]) {id = 6 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
        linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%alloc_17, %alloc_18 : memref<32x32xf32, 2>, memref<32x32xf32, 2>) outs(%alloc_19 : memref<32x32xf32, 2>) {
        ^bb0(%in: f32, %in_20: f32, %out: f32):
          %59 = arith.addf %in, %in_20 : f32
          linalg.yield %59 : f32
        }
        air.dma_memcpy_nd (%arg27[%57, %58] [%c32, %c32] [%c64_16, %c1_15], %alloc_19[] [] []) {id = 7 : i32} : (memref<64x64xf32>, memref<32x32xf32, 2>)
      ...
      air.herd @herd_2  tile (%arg21, %arg22) in (%arg23=%c2, %arg24=%c2) args(%arg25=%arg16, %arg26=%alloc_12, %arg27=%alloc_13) : memref<64x64xf32>, memref<64x64xf32>, memref<64x64xf32> {
        %c1_15 = arith.constant 1 : index
        %c64_16 = arith.constant 64 : index
        %c32 = arith.constant 32 : index
        %57 = affine.apply #map()[%arg21]
        ...
        %alloc_18 = memref.alloc() : memref<32x32xf32, 2>
        %alloc_19 = memref.alloc() : memref<32x32xf32, 2>
        air.dma_memcpy_nd (%alloc_17[] [] [], %arg25[%57, %58] [%c32, %c32] [%c64_16, %c1_15]) {id = 8 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
        air.dma_memcpy_nd (%alloc_18[] [] [], %arg26[%57, %58] [%c32, %c32] [%c64_16, %c1_15]) {id = 9 : i32} : (memref<32x32xf32, 2>, memref<64x64xf32>)
        linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%alloc_17, %alloc_18 : memref<32x32xf32, 2>, memref<32x32xf32, 2>) outs(%alloc_19 : memref<32x32xf32, 2>) {
        ^bb0(%in: f32, %in_20: f32, %out: f32):
          %59 = arith.addf %in, %in_20 : f32
          linalg.yield %59 : f32
        }
        air.dma_memcpy_nd (%arg27[%57, %58] [%c32, %c32] [%c64_16, %c1_15], %alloc_19[] [] []) {id = 10 : i32} : (memref<64x64xf32>, memref<32x32xf32, 2>)
        memref.dealloc %alloc_17 : memref<32x32xf32, 2>
        memref.dealloc %alloc_18 : memref<32x32xf32, 2>
        memref.dealloc %alloc_19 : memref<32x32xf32, 2>
        air.herd_terminator
      ...
      scf.yield %alloc_14, %52, %c0, %56, %c0 : memref<64x64xf32>, index, index, index, index
    }
    ...
    %reinterpret_cast_2 = memref.reinterpret_cast %arg2 to offset: [%32], sizes: [64, 64], strides: [%28, %30] : memref<*xf32> to memref<64x64xf32, strided<[?, ?], offset: ?>>
    ...
    %subview = memref.subview %27#0[0, 0] [%41, %42] [1, 1] : memref<64x64xf32> to memref<?x?xf32, strided<[64, 1]>>
    %subview_3 = memref.subview %reinterpret_cast_2[0, 0] [%41, %42] [1, 1] : memref<64x64xf32, strided<[?, ?], offset: ?>> to memref<?x?xf32, strided<[?, ?], offset: ?>>
    memref.copy %subview, %subview_3 : memref<?x?xf32, strided<[64, 1]>> to memref<?x?xf32, strided<[?, ?], offset: ?>>
    memref.dealloc %27#0 : memref<64x64xf32>
    return
  }
}
